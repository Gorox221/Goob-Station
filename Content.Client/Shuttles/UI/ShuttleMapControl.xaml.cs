...
public sealed partial class ShuttleMapControl : BaseShuttleControl
{
    ...
    protected override void Draw(DrawingHandleScreen handle)
    {
        ...
        foreach (var mapObj in mapObjects)
        {
            ...
            // Check if it intersects the viewport.
            var coords = EntManager.GetCoordinates(biome.Coordinates);
            var mapCoords = _xformSystem.ToMapCoordinates(coords);
            var enlargedBounds = viewBox.Enlarged(biome.AverageRadius);
            ...
            {
                var bl = biome.BoundaryLines[i];
                var br = biome.BoundaryLines[i + 1];
